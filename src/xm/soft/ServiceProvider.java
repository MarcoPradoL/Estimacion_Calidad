...
public class ServiceProvider {
	...
	public static void main(String arg[]) throws Exception{
		...
		ServiceProvider provider = new ServiceProvider(urlMozilla);
		printTest(provider);
		provider = new ServiceProvider(urlWikimedia);
		printTest(provider);
		provider = new ServiceProvider(urlCloudMonitor);
		printTest(provider);
		
	}
	public static void printTest(ServiceProvider provider){
	...
	public ServiceProvider(String strUrl) throws ServiceProviderException{
